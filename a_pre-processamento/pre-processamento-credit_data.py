...
"""O objetivo deste arquivo é realizar o pré-processamento dos dados da base de
dados 'credit_data.csv', localizado no diretório 'arquivos', para que,
posteriormente possa ser aplicado um Algoritmo de Machine Learning.

Após os procedimentos devidos, serão salvos arquivos com os dados já tratados.
===============================================================================
Descrição do arquivo 'credit_data.csv'

Cada campo (coluna) é separado por vírgula e, cada uma das colunas armazena um
...
NOTA: TODOS OS ATRIBUTOS POSSUEM VALORES DO TIPO NUMÉRICO.
===============================================================================
...
--- QuantileTransformer()
--- PowerTransformer()
- Salvar a base de dados em um arquivo."""
...
np.savetxt(path.join('a_pre-processamento',
					 'pre-processamento-credit_data-previsores.data'),
		   previsores, fmt='%f', delimiter=',')
